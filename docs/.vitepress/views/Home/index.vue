  ...
  <div class="home flex h-screen w-screen items-center justify-center">
    ...
    <div class="-mt-10 sm:-mt-40 flex w-screen animate-scale-in-center flex-col px-4 sm:w-[626px]">
      ...
      >
        ...
        <p class="mt-2 sm:text-lg text-base">DongCY's Tech Blog / Front-End Developer</p>
        <p class="mt-1 text-black/50">“🚀长路漫漫其修远兮，吾将上下而求索”</p>
        <div class="mt-4 flex gap-4">
          <div
            @click="router.go(withBase('/AboutMe'))"
...
const gotoGithub = () => {
  window.open('https://github.com/dongcy97')
}
